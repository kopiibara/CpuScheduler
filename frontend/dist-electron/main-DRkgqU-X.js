import require$$0$4 from "electron";
...
(function(module) {
  ...
  const chokidar$1 = chokidar;
  const fs2 = require$$0$2;
  const { spawn } = require$$3;
  ...
  module.exports = function elecronReload(glob, options = {}) {
    ...
    const watcher = chokidar$1.watch(glob, Object.assign({ ignored: [ignoredPaths, mainFile] }, options));
    ...
    if (eXecutable) {
      if (!fs2.existsSync(eXecutable)) {
        throw new Error("Provided electron executable cannot be found or is not exeecutable!");
      }
      const hardWatcher = chokidar$1.watch(mainFile, Object.assign({ ignored: [ignoredPaths] }, options));
